...
var _barduino = require('./barduino');

var _barduino2 = _interopRequireDefault(_barduino);

var _oldMacDonald = require('./songs/oldMacDonald');
...
},{"./barduino":3,"./songs/oldMacDonald":6}],3:[function(require,module,exports){
'use strict';
...
var _octave = require('./octave');

var _octave2 = _interopRequireDefault(_octave);

var _socket = require('../../node_modules/socket.io/node_modules/socket.io-client/socket.io');
...
var Barduino = function () {
    function Barduino(targetID, opts) {
        ...
        opts = opts || {};
        console.log(Barduino.prototype);
...
},{"../../node_modules/socket.io/node_modules/socket.io-client/socket.io":1,"./octave":4,"./oscillator":5}],4:[function(require,module,exports){
'use strict';
...
var oldMacDonaldSong = exports.oldMacDonaldSong = {
    notes: [['g', 1], ['g', 1], ['g', 1], ['d', 1], ['e', 1], ['e', 1], ['d', 2], ['b', 1], ['b', 1], ['a', 1], ['a', 1], ['g', 1], ['~', 2], ['d', 1], ['g', 1], ['g', 1], ['g', 1], ['d', 1], ['e', 1], ['e', 1], ['d', 2], ['b', 1], ['b', 1], ['a', 1], ['a', 1], ['g', 3], ['d', 0.5], ['d', 0.5], ['g', 1], ['g', 1], ['g', 1], ['d', 0.5], ['d', 0.5], ['g', 1], ['g', 1], ['g', 1], ['~', 1], ['g', 0.5], ['g', 0.5], ['g', 1], ['g', 0.5], ['g', 0.5], ['g', 1], ['g', 0.5], ['g', 0.5], ['g', 0.5], ['g', 0.5], ['g', 1], ['g', 1]],
    bpm: 240,
    repeat: true
};
